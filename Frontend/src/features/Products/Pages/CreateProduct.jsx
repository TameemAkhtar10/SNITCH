    ...
    <section className="product-root flex min-h-screen items-center justify-center px-7 py-12 sm:px-10">
        <div className="product-form-container mx-auto w-full">
            ...
            <form onSubmit={handleSubmit} className="mt-8">
                ...
                <div className="product-field">
                    <input id="variants" name="variants" type="text" className="product-input" placeholder=" " value={formData.variants} onChange={handleChange} />
                    <label htmlFor="variants" className="product-label">Variants (JSON)</label>
                </div>
